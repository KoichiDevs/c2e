    ...
    return (
        <PageTrans>
            <section className="w-full h-auto min-h-screen bg-blk relative flex items-start py-20">
                ...
                <h1 className="text-white/10 text-[10rem] absolute bottom-0 -right-20 font-[700] lg:block hidden">STARTUP</h1>
                ...
                <div className="text-white font-raleway px-10 max-w-[1500px] w-full mx-auto mt-[4rem] relative flex items-center">
                    ...
                    <div className=" w-[40%] items-center justify-center flex">
                        <ImageAnim>
                            <img src="/Clock.webp" alt="NFT" className="w-[20rem] mt-5 2xl:w-[25rem] lg:block hidden" />

                        </ImageAnim>

                        <img src="/Clock.webp" alt="NFT" className="w-[20rem] mt-5 2xl:w-[25rem] absolute opacity-10 lg:hidden block bottom-5 right-5" />
